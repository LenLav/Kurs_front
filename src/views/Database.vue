...
<body>
    ...
    <div v-show="add_person_TRUE" class="add_news" style="top: 50px;">
        ...
        <div class="add_content_news">
            <h4 class="h4_new">Форма добавления сотрудника<i class="bi bi-x-lg close_icon" style="top: 60px;" @click="add_person_TRUE = !add_person_TRUE"></i></h4>

            <div class="container_add_new">
                <table class="TableCheck">
                    <tr>
                        <td class="TdLev">Фамилия Имя Отчество</td>
                        <td class="TdPrav"><input v-model="form.fio" type="text" style="width: 80%;"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="TdPrav"><input v-model="form.pasport" type="text" placeholder="xx xx xxxx" style="width: 80%;"></td>
                    </tr>
                    <tr>
                        <td class="TdLev">Дата рождения</td>
                        <td class="TdPrav"><input v-model="form.birthday" type="date" style="width: 80%;"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="TdPrav"><input v-model="form.salary" type="number" style="width: 80%;"></td>
                    </tr>
                    <tr>
                        <td class="TdLev">Дата приема на работу:</td>
                        <td class="TdPrav"><input v-model="form.date_of_receipt" type="date" style="width: 80%;"></td>
                    </tr>
                    <tr>
            ...
            <p><button type="button" class="osnovnButton" style="" @click="add_person()">Добавить</button></p>
        </div>
    </div>
            ...
            <table id="myTable" class="table tablesorter table-hover table-bordered table-striped table-light">
                ...
                <tbody>
                    <tr class="tableSize" v-for="user in users" :key="user.id">
                        ...
                        <td class="align-middle ">{{ user.fio }}
                            <i v-show="user.isAdmin" class="bi bi-check-circle" style="color: green;" data-bs-toggle="tooltip" title="Администратор"></i></td>
...
export default class Home extends Vue {
    ...
    async mounted() {
        ...
        this.func_me_inf()
        // this.GetListJob()
        // var rates = (<HTMLInputElement>document.getElementById('check_id')).checked;
        // console.log(rates)
    }
